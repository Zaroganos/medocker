#!/usr/bin/env python3
"""
Medocker Build Script (Automated)

This script builds standalone executables for the Medocker application using PyInstaller.
All actions are automated without requiring user interaction.
"""
...
def auto_check_prerequisites():
    """Check if PyInstaller is installed and handle pathlib issue automatically."""
    ...
    if pathlib_spec and "site-packages" in str(pathlib_spec.origin):
        ...
        print("Automatically uninstalling pathlib backport...")
        try:
    ...
    try:
        ...
        try:
            ...
            print("Failed to install PyInstaller. You may need to run this script with administrator privileges.")
            return False
...
def clean_build_directories():
    ...
    directories = ['build', 'dist', 'releases']
...
def create_distribution_package():
    ...
    with open(readme_path, "w") as f:
        ...
        f.write("For more information, visit: https://github.com/Zaroganos/medocker\n")
...
def main():
    ...
    print("=== Medocker Automated Build Script ===")
    
    # Check prerequisites
    if not auto_check_prerequisites():
        return 1
